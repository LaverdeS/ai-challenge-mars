...
flags.DEFINE_integer("test_epoch", 100, "Epoch for latent mapping in anomaly detection to train [100]") #100
...
flags.DEFINE_boolean("anomaly_test", True, "True for anomaly test in test directory, not anomaly test [False]") #false
flags.DEFINE_boolean("visualize", True, "True for visualizing, False for nothing [False]") #false
